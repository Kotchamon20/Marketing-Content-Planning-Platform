...
-- 2. ลบคอลัมน์ที่ซ้ำซ้อนหรือไม่ได้ใช้งาน (Cleanup Duplicate/Unused Fields)
ALTER TABLE content_items DROP COLUMN IF EXISTS platform;
ALTER TABLE content_items DROP COLUMN IF EXISTS content_group;
